...
final class PintoObjectSlotsValidationFailurePhpType
{
    ...
    private function pintoMapping(): PintoMapping
    {
        return new PintoMapping(
            resources: [
                static::class => ObjectListEnumResource::createFromEnum(PintoListSlots::PintoObjectSlotsValidationFailurePhpType),
            ],
            definitions: [
                static::class => new Slots\Definition(new Slots\SlotList([
                    new Slots\Slot(name: 'number', defaultValue: null),
                ])),
            ],
            buildInvokers: [
